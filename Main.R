...
#Plot the partial effects of each individual predictors on the intercept and slope of the size spectra
#source('Interactive_effects_slope_spectra.R')

# Plot the global distributions of means size and size variance
#source('GLobal_size_Spectra.R')

# Plot the global distributions of the intercept and slope of the size spectra
source('GLobal_size_Spectra_slope.R')
